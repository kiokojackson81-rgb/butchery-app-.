...
export default function PerformanceView() {
  ...
  return (
    <div className="performance-view">
      ...
      {tab === 'attendants' && (
        <section className="rounded-2xl border p-4">
          <h3 className="font-semibold mb-2">Attendant KPIs</h3>
          <div className="table-wrap">
            <table className="w-full text-sm border">
              <thead>
                <tr className="text-left border-b">
      ...
      {tab === 'waste' && (
        <section className="rounded-2xl border p-4">
          <h3 className="font-semibold mb-2">Waste — {date}{outlet? ` · ${outlet}`: ''}</h3>
          <div className="table-wrap">
            <table className="w-full text-sm border">
              <thead>
                <tr className="text-left border-b">
      ...
      {tab === 'intervals' && (
        <section className="rounded-2xl border p-4">
          <h3 className="font-semibold mb-2">Supply Intervals{outlet? ` — ${outlet}`:''}</h3>
          <div className="table-wrap">
            <table className="w-full text-sm border">
              <thead>
                <tr className="text-left border-b">
